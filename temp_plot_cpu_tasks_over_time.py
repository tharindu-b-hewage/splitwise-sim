...
for rate in [str(rate) for rate in range(90, 191, 20)]:
    top_root = "/Users/tharindu/workspace/splitwise-sim"
    root = top_root + "/results/0/splitwise_1_1"
    ...
    ax2.set_title('Memory For rate' + str(rate))
